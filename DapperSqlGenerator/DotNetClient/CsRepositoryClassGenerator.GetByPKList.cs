...
namespace DapperSqlGenerator.DotNetClient
{
    public partial class CsRepositoryClassGenerator : GeneratorBase
    {
        ...
        /// Select by PK List
        /// </summary>
        public async Task<IEnumerable<{_entityClassFullName}>> GetByPKList(IEnumerable<{_entityClassName}_PK> pkList)
        {{
        ...
        /// </summary>
        private object Create{_entityClassName}PKDataTable(IEnumerable<{_entityClassName}_PK> pkList)
        {{
